...
>(({ className, ...props }, ref) => (
  <div className="bm-flex bm-items-center bm-border-b bm-px-3" cmdk-input-wrapper="">
...
>((props, ref) => (
  <CommandPrimitive.Empty
    ref={ref}
    className="bm-py-6 bm-text-center bm-text-sm"
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Separator
    ref={ref}
    className={cn("bm--mx-1 bm-h-px bm-bg-border", className)}
    {...props}
  />
))
