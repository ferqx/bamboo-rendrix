...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "bm-flex bm-flex-col bm-space-y-1.5 bm-text-center sm:bm-text-left",
      className
    )}
    {...props}
  />
...
const DialogFooter = ({
  ...
  <div
    className={cn(
      "bm-flex bm-flex-col-reverse sm:bm-flex-row sm:bm-justify-end sm:bm-space-x-2",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      "bm-text-lg bm-font-semibold bm-leading-none bm-tracking-tight",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn("bm-text-sm bm-text-muted-foreground", className)}
    {...props}
  />
))
