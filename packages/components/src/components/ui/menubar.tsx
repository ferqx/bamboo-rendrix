...
>(({ className, inset, ...props }, ref) => (
  <MenubarPrimitive.Label
    ref={ref}
    className={cn('bm-px-2 bm-py-1.5 bm-text-sm bm-font-semibold', inset && 'bm-pl-8', className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Separator ref={ref} className={cn('bm--mx-1 bm-my-1 bm-h-px bm-bg-muted', className)} {...props} />
));
