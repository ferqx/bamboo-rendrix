...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Root
    ref={ref}
    className={cn(
      "bm-relative bm-z-10 bm-flex bm-max-w-max bm-flex-1 bm-items-center bm-justify-center",
      className
    )}
    {...props}
  >
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.List
    ref={ref}
    className={cn(
      "bm-group bm-flex bm-flex-1 bm-list-none bm-items-center bm-justify-center bm-space-x-1",
      className
    )}
    {...props}
  />
